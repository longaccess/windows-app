...
namespace ThriftInterface
{
  public partial class CLI {
    public interface Iface {
      ...
      #endif
      void UploadToCapsule(string ArchiveLocalID, string CapsuleID, string title, string description, bool sandbox);
      #if SILVERLIGHT
      IAsyncResult Begin_UploadToCapsule(AsyncCallback callback, object state, string ArchiveLocalID, string CapsuleID, string title, string description, bool sandbox);
    ...
    public class Client : IDisposable, Iface {
      ...
      #if SILVERLIGHT
      public IAsyncResult Begin_UploadToCapsule(AsyncCallback callback, object state, string ArchiveLocalID, string CapsuleID, string title, string description, bool sandbox)
      {
        return send_UploadToCapsule(callback, state, ArchiveLocalID, CapsuleID, title, description, sandbox);
      }
      ...
      public void UploadToCapsule(string ArchiveLocalID, string CapsuleID, string title, string description, bool sandbox)
      {
        #if !SILVERLIGHT
        send_UploadToCapsule(ArchiveLocalID, CapsuleID, title, description, sandbox);
        recv_UploadToCapsule();

        #else
        var asyncResult = Begin_UploadToCapsule(null, null, ArchiveLocalID, CapsuleID, title, description, sandbox);
        End_UploadToCapsule(asyncResult);

        #endif
      }
      #if SILVERLIGHT
      public IAsyncResult send_UploadToCapsule(AsyncCallback callback, object state, string ArchiveLocalID, string CapsuleID, string title, string description, bool sandbox)
      #else
      public void send_UploadToCapsule(string ArchiveLocalID, string CapsuleID, string title, string description, bool sandbox)
      #endif
      {
    ...
    public class Processor : TProcessor {
      ...
      public void UploadToCapsule_Process(int seqid, TProtocol iprot, TProtocol oprot)
      {
        ...
        UploadToCapsule_result result = new UploadToCapsule_result();
        try {
          iface_.UploadToCapsule(args.ArchiveLocalID, args.CapsuleID, args.Title, args.Description, args.Sandbox);
        } catch (InvalidOperation error) {
          result.Error = error;
        }
